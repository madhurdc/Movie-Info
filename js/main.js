...
function getMovies(searchText){
    ...
    .catch((err) => {
        console.log(err);
        $('#movies').html('<p class="text-danger">No movies found or error occurred.</p>');
    });
}
...
function getMovie() {
    ...
    axios.get(`/api/movies?title=${encodeURIComponent(movieId)}&type=id`)
    .then((response) => {
    ...
    .catch((err) => {
        console.log(err);
        $('#movie').html('<p class="text-danger">Movie details not found or error occurred.</p>');
    });
}
